...
- [RAxML-NG](https://cme.h-its.org/exelixis/resource/download/NewManual.pdf) - a tool for performing Maximum Likelihood based inference of large phylogenetic trees
...
**RAxMLNG** - The RAxMLNG directory contains the output produced by RAxML-NG, the RAxML-NG *.support* is the best tree generated during the phylogenetic analysis in Newick format, containing the supporting bootstrap values. This is the tree visualized by Gotree.
...
| Prefix                              | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **.bestTree**                 | Contains the best-scoring ML tree of a thorough ML analysis |
| **.bestModel**                | 	Optimized model parameters for the best-scoring ML tree |
| **.bootstraps**               | All final bootstrapped trees |
| **.log**                      | Screen log |
| **.mlTrees**                  | ML trees for each starting tree  |
| **.rba**                      | Compressed MSA in binary format (RAxML Binary Alignment) |
| **.startTree**                | Starting tree(s) used for ML inference |
| **.support**                  | Best-scoring ML tree with bootstrap support values |
  </center>
