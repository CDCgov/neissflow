...
**RAxML** - The RAxML directory contains the output produced by RAxML, the RAxML*bestTree.core* is the best tree generated during the phylogenetic analysis in Newick format. This is the tree visualized by Gotree.
